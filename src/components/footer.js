        ...
        <div className="container py-5">
          <div className="row g-5">
            <div className="col-lg-3 col-md-6">
              ...
              <p className="mb-2"><i className="fa fa-map-marker-alt me-3" />Surampalem,Andhrapradesh</p>
              <p className="mb-2"><i className="fa fa-phone-alt me-3" />+91 12345 67862</p>
              <p className="mb-2"><i className="fa fa-envelope me-3" />name@gmail.com</p>
            ...
            <div className="col-lg-3 col-md-6">
              <h4 className="text-white mb-4">Contacting hours</h4>
