                ...
                <div className="container">
                  <div className="row justify-content-start">
                    <div className="col-lg-7 text-start">
                      <p className="fs-4 text-white animated slideInRight">Welcome to <strong>Digigrow</strong></p>
                      <h1 className="display-1 text-white mb-4 animated slideInRight">Upgrade your business</h1>
                      <a href className="btn btn-primary rounded-pill py-3 px-5 animated slideInRight">More info</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="container">
                  <div className="row justify-content-end">
                    <div className="col-lg-7 text-end">
                      <p className="fs-4 text-white animated slideInLeft">Welcome to <strong>Digigrow</strong></p>
                      <h1 className="display-1 text-white mb-5 animated slideInLeft">Grow and shine</h1>
                      <a href className="btn btn-primary rounded-pill py-3 px-5 animated slideInLeft">More info</a>
                    </div>
                  </div>
                </div>
              </div>
